...
public class ing_mecanica implements programa_academico {
    ...
    public ing_mecanica(String nombre, String lema, double costo, int estudiantes) {
        this.nombre = nombre;
        this.lema = lema;
        this.costo = costo;
    ...
    public void ver_metales(){
        System.out.println("Metales");
    }

    public void ver_circuitos(){
